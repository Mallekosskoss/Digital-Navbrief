...
def calculate_event_times(latitude_deg, longitude_deg):
    ...
    event_angles = [0, -6, -12, -18]  # Vinkel ved solnedgang/oppgang og ulike tussemørker
    event_times = {}
...
with open("C:/Users/LAB/Dropbox/Bachelor/data_inn/live_pos/ais.txt", "r") as file:
    data = json.load(file)
...
with open('C:/Users/LAB/Dropbox/Bachelor/data_inn/live_pos/astronomisk_live.csv', mode='w', newline='', encoding="utf-8") as file:
